 <script>
     var credit = parseFloat(document.getElementById('credit-score').textContent) || 0;
     var itrs = parseFloat(document.getElementById('itrs-score').textContent) || 0;
     var risk = parseFloat(document.getElementById('risk-score').textContent) || 0;

     // Calculate the total score
     var total = credit + itrs + risk;
