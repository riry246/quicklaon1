    ...
    <div class="main-header-dropdown dropdown-menu dropdown-menu-end" data-popper-placement="none">
        <div class="p-3">
            <div class="d-flex align-items-center justify-content-between">
                ...
                @if (count(auth()->user()->unreadNotifications) > 0)
                    <a href="{{ route('app.mark-as-read') }}"><span class="badge bg-secondary-transparent"
        ...
        @if (count(auth()->user()->unreadNotifications) > 0)
                            ...
                            <div class="flex-grow-1 d-flex align-items-center justify-content-between">
                                <div>
                                    <p class="mb-0 fw-semibold"><a
                                            href="javascript:void()">{{ $notificationData['heading'] }}</a>
                                    </p>
                                    <span
            ...
            <div class="p-3 empty-header-item1 border-top">
                <div class="d-grid">
                    <a href="{{ route('app.notiifcaiton') }}" class="btn btn-primary">View All</a>
                </div>
            </div>
        @else
