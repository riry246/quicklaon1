            ...
            <div class="container">
                <div class="text-center p-5 my-auto">
                    <div class="row align-items-center justify-content-center h-100">
                        <div class="col-xl-7">
                            <p class="error-text mb-sm-0 mb-2">405</p>
                            <p class="fs-18 fw-semibold mb-3">Oops &#128557;,Method not allowed.
                            </p>
                            ...
                            <a href="https://{{ parse_url(url()->current(), PHP_URL_HOST) }}" class="btn btn-primary"><i
