@php
    $applications = $dashboard_helper->getHighRiskAccount();
@endphp
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card custom-card bg-light">
                        <div class="card-header justify-content-between">
                            <div class="card-title">{{ count($applications) }} No Successful Debit</div>
                        </div>
                        <div class="card-body">
                                    ...
                                    <tbody>
                                        @foreach ($applications as $application)
                                            <tr>
                                                ...
                                                <td>{{ $loan_helper->formatCurrency($application->approved_amount) }}</td>
                                            </tr>
                                        @endforeach
                                    </tbody>
                                </table>
