<div class="card custom-card">
    <div class="card-header justify-content-between flex-wrap">
        ...
        <div class="btn-group" role="group" aria-label="Basic example">
            <a href="{{ route('transaction.check', $transaction->id) }}" class="btn btn-primary btn-sm btn-wave">Check
                Payment Status</a>
            <button class="btn btn-sm btn-danger ms-2" href="javascript:void(0);" data-bs-toggle="modal"
                data-bs-target="#revert"><i class='bx bx-revision'></i> Revert Transaction</button>
        </div>
    </div>
    <div class="card-body">
        ...
        <div class="d-flex w-100 border-bottom border-block-end-dashed">
            <div class="d-flex align-items-center justify-content-between w-100 flex-wrap mt-3 mb-3">
                ...
                <div class="me-3">
                    ...
                    <p class="fw-normal">
                        {{ $loan_helper->formateDate($transaction->expected_clearance_date_for_funds) ?? 'N/A' }}</p>
                </div>
                <div class="me-3">
