...
@php $selected = $module_action_helper->selected($permissions) @endphp
            ...
            <div class="col-xl-12">
                <div class="card custom-card">
                    ...
                    <div class="card-body">
                        ...
                        <form class="row g-3 mt-0" method="POST" action="{{ route('group.update', $group->id) }}">
                            @csrf
                            ...
                            <div class="col-md-12">
                                ...
                                <textarea name="description" class="form-control">{{ old('content', $group->description) }}</textarea>
                            </div>
                            <div class="col-md-12">
                                                            ...
                                                            <div class="col-3 mb-2">
                                                                <div class="form-check-danger form-check form-switch">
                                                                    <input class="form-check-input"
                                                                        value="{{ $action->id }}"
                                                                        {{ in_array($action->id, $selected) ? 'checked' : '' }}
