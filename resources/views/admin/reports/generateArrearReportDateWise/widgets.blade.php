    ...
    <div class="card-header">
        <div class="d-flex w-100">
            <div class="d-flex align-items-center justify-content-between w-100 flex-wrap">
                ...
                <div class="me-3 mb-3">
                    <p class="text-muted mb-0">Arrears Amount</p>
                    <p class="fw-semibold fs-16 mb-0">
                        {{ $loan_helper->formatCurrency($report['totalDishonoredAmount']) }}</p>
                </div>
                <div class="me-3 mb-3">
                    <p class="text-muted mb-0">Active Lone in Arrears</p>
                    <p class="fw-semibold fs-16 mb-0">{{ $report['totalActiveLoansInArrears'] }}
                    </p>
                </div>
                <div class="me-3 mb-3">
