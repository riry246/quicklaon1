                    ...
                    <div class="col-1">
                        <div class="dropdown" style="float:right"> <a aria-label="anchor" href="javascript:void(0);"
                            ...
                            <ul class="dropdown-menu">
                                <li><a class="dropdown-item" href="{{ route('bankStatement.consumer.update', $basiq_user_id) }}">Update</a></li>
                                <li><a class="dropdown-item" href="{{ route('bankStatement', $basiq_user_id) }}">Individual Statement</a></li>
                                <li><a class="dropdown-item" href="{{ route('bankStatement.affordability', $basiq_user_id) }}">Affordability Statement</a></li>
                            </ul>
                        </div>
