            ...
            <div class="col-xl-12">
                <div class="card custom-card overflow-hidden" ref="cardElement">
                    ...
                    <div class="card-footer d-sm-flex d-block align-items-center justify-content-between shadow-lg">
                        ...
                        <div class="btn-list mt-sm-0 mt-2" v-if="val.contract.signed_date_cf">
                            <button class="btn btn-success btn-wave">Signed</button>
                        </div>
                        <div class="btn-list mt-sm-0 mt-2" v-else>
                            <button class="btn btn-primary btn-wave" data-bs-effect="effect-super-scaled"
                                data-bs-toggle="modal" href="#signature">Sign Document</button>
                        </div>
                    </div>
                </div>
            </div>
                                    ...
                                    <div class="tab-pane border-0 active p-0" id="draw" role="tabpanel"
                                        ...
                                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12"> <label for="input-tel"
                                            ...
                                            <div class="btn-group mt-2" role="group" aria-label="Basic example">
                                                <button class="btn btn-icon btn-light btn-wave btn-outline-info"
                                                    @click="save">
    ...
    methods: {
        ...
        submitSignature() {
            ...
            if (this.formdata.signature_customer == null) {
                ...
                axios.post(this.baseUrl + 'api/auth/admin/contract', { data: this.formdata })
                    .then(response => {
        ...
        viewed() {
            ...
            axios.post(this.baseUrl + 'api/auth/admin/contract/viewed', { data: this.formdata })
                .then(response => {
